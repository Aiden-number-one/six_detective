      ...
      <Layout className={classNames(styles.layout, styles.sideBar)}>
        <div className={styles.header}>
          <div className={styles.title}>
            {<FormattedMessage id="report-designer.widgetcontrol" />}
          </div>
            ...
            >
              <Panel header={<FormattedMessage id="report-designer.basic" />} key="1">
                <Form colon={false}>
                  {/* 控件类型 */}
                  <Form.Item
                    label={<FormattedMessage id="report-designer.widgettype" />}
                    {...formLayout}
                  >
                  ...
                  {/* 标签名称 */}
                  <Form.Item
                    label={<FormattedMessage id="report-designer.tag-name" />}
                    {...formLayout}
                  >
                  ...
                  {/* 提示文字 */}
                  <Form.Item
                    label={<FormattedMessage id="report-designer.tooltip" />}
                    {...formLayout}
                  >
                  ...
                  {/* 表字段 */}
                  <Form.Item
                    label={<FormattedMessage id="report-designer.field" />}
                    {...formLayout}
                  >
                    {getFieldDecorator('roleName', {})(<Input />)}
                  </Form.Item>
            ...
            >
              <Panel header={<FormattedMessage id="report-designer.option" />} key="1">
                <Form>
                  {/* 来源于 */}
                  <Form.Item
                    label={<FormattedMessage id="report-designer.from" />}
                    labelCol={{ span: 10 }}
                    wrapperCol={{ span: 14 }}
                  >
                    {getFieldDecorator('roleName', {})(<Select />)}
