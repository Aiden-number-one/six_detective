...
//				$("#btn-clear").linkbutton("disable");// 按钮不可用
				...
				$.ajax({
					type : 'get',
//					dataType : 'json',
					url : 'monitorClear/dClear.action?jid='+jid+"&batchStrat="+batchStrat+"&batchEnd="+batchEnd
...
//						if(result){
							window.location.href = 'monitorClear/exportCSV.action?jid='+jid+"&batchStrat="+batchStrat+"&batchEnd="+batchEnd
								+"&timeStart="+timeStart+"&timeEnd="+timeEnd;
//						}
//					}
//				});
