		...
		success: function success(result) {
			...
			if (result.rows != null && result.rows.length > 0) {
				for (var i = 0; i < result.rows.length; i++) {
					if (i < 9) {
						var resorceInfo = '<li waringId="' + result.rows[i].waringId + '" class="test">' + '<a>&nbsp;<span id="' + result.rows[i].waringId + '">' + (i + 1) + '.&nbsp;&nbsp;&nbsp;' + result.rows[i].waringTitile + '<span>' + '&nbsp;&nbsp;&nbsp;' + result.rows[i].modifiedTime + '</a></li>';
					} else {
						var resorceInfo = '<li waringId="' + result.rows[i].waringId + '" class="test">' + '<a>&nbsp;<span id="' + result.rows[i].waringId + '">' + (i + 1) + '.&nbsp;&nbsp;&nbsp;' + '<span id="' + result.rows[i].waringId + '">' + result.rows[i].waringTitile + '<span>' + '&nbsp;&nbsp;&nbsp;' + result.rows[i].modifiedTime + '</a></li>';
					}
