...
define(function (require, exports, module) {
    ...
    showContent.get_source_connect_List = function (val) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_data_source_config",
            "v4.0",
            paramsMap,
            function (data) {
     ...
     showContent.getUser = function(params) {
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_schemas_from_tables_info",
            "v4.0", params,
            function(data) {
                var items = data.bcjson.items || data.bcjson;
                if (data.bcjson.flag == "1" && items) {
    ...
    showContent.qry_connect_data = function (params) {
        ...
        $.kingdom.getList({
            apiName: "kingdom.retl.get_metadata_table_info",
            apiVision: "v4.0",
            params: _params,
    ...
    showContent.testDataConnectList = function (params) {
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_data_source_connect_test",
            "v4.0",
            params,
            function (data) {
                App.unblockUI();
    ...
    showContent.addDataConnectList = function (params) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_data_source_config",
            "v4.0",
            paramsMap,
            function (data) {
                App.unblockUI();
    ...
    showContent.getImportDataSource = function (connection_id) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_db_metadata_schemas",
            "v4.0",
            params,
            function (data) {
      ...
      showContent.listImport = params => {
        return new Promise((resolve, reject) => {
            $.kingdom.doKoauthAdminAPI("kingdom.retl.get_metadata_table_export_info", "v4.0", params, data => {
    ...
    showContent.deleteTableList = function (isRightActionDelete, tableid) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_metadata_tables_del",
            "v4.0",
            params,
            function (data) {
                App.unblockUI();
    ...
    showContent.metadataTablesUpd = function () {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_metadata_tables_upd",
            "v4.0",
            params,
            function (data) {
                App.unblockUI();
    ...
    showContent.tableRecordcountUpd = function () {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_table_recordcount_upd",
            "v4.0",
            params,
            function (data) {
                App.unblockUI();
    ...
    showContent.getTabColumnInfo = function (tableId) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_metadata_column_info",
            "v4.0",
            paramsMap,
            function (data) {
                var items = data.bcjson.items || data.bcjson;
    ...
    showContent.previewAction = function (schema, table_name) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_metadata_table_perform",
            "v4.0",
            paramsMap,
            function (data) {
    ...
    showContent.getExcelContentList = function () {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_file_content_info",
            "v4.0",
            paramsMap,
            function (data) {
                if (data.bcjson.flag === "1") {
                    ...
                    var tableBodyOption = '';
                    var columnIndex = 0;
                    for (var singleData of newItems) {
                        var index = 0;
                        columnIndex++;
                        var columnData = '<td class="t-c" class="t-c"><input type="checkbox"></td><td class="t-c">' + columnIndex + '</td>';
                        for (var insideObj in singleData) {
                            columnData =
                                columnData + "<td> " + singleData[insideObj] + "</td>";
                            index++;
                        ...
                        if (index === num) {
                            tableBodyOption = tableBodyOption + "<tr>" + columnData + "</tr>";
                        }
                    }
    ...
    showContent.getExcelFileTypeData = function (paramsMap) {
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_file_data_source_info",
            "v4.0",
            paramsMap,
            function (data) {
                var items = data.bcjson.items || data.bcjson;
    ...
    showContent.getExcelFileDetail = function (paramsMap) {
        $.kingdom.getList({
            apiName: "kingdom.retl.get_file_data_source_info",
            apiVision: "v4.0",
            params: paramsMap,
    ...
    showContent.getExcelSingleFileDetail = function (paramsMap) {
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.get_target_table_data_info",
            "v4.0",
            paramsMap,
            function (data) {
                var items = data.bcjson.items || data.bcjson;
    ...
    */
    showContent.editExcelSingleFileDetail = function (paramsMap) {
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_target_table_data",
            "v4.0",
            paramsMap,
            function (data) {
                App.unblockUI();
