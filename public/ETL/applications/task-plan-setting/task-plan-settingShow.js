...
define(function (require, exports, module) {
    ...
    showContent._load = function () {
        ...
        var lastExecState = sessionStorage.getItem("type");
        if (lastExecState) {
    ...
    showContent.getNewTree = function () {
        $.kingdom.doKoauthAdminAPI("bayconnect.superlop.get_jobs_list", "v4.0", {
            pageSize: '999',
            pageNumber: '1'
        }, function (data) {
                ...
                try {
                    for (var _iterator = items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        $.each(folderArray, function (index, value) {
                            ...
                            try {
                                for (var _iterator2 = currentPath[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                                    var items1 = _step2.value;
    ...
    // 查询列表
    showContent.getTaskSetList = function (params) {
        $.kingdom.getList({
    ...
    showContent.addPlanSet = function (params) {
        ...
        $.kingdom.doKoauthAdminAPI("bayconnect.superlop.set_schedule_info_modify", "v4.0", paramsMap, function (data) {
            App.unblockUI();
