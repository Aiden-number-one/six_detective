...
define(function (require, exports, module) {
    ...
    showContent.getTaskSetList = params => {
        $.kingdom.getList({
            apiName: "kingdom.retl.get_schedule_info",
            apiVision: "v4.0",
            params: params,
    ...
    showContent.addPlanSet = function (params) {
        ...
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_schedule_info_modify",
            "v4.0",
            paramsMap,
            data => {
                App.unblockUI();
    ...
    showContent.deletePlanSet = function (params) {
        paramsMap = $.extend({ operType: "DEL" }, params);
        $.kingdom.doKoauthAdminAPI(
            "kingdom.retl.set_schedule_info_modify",
            "v4.0",
            paramsMap,
    ...
    showContent.handleFrequency = function () {
        ...
        //获取执行频率的单位类型
        var frequency = $("#J_form_basc select[name='frequency']").val();
        //获取执行频率的input
