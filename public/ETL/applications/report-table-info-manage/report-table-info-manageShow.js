define(function(require, exports, module) {
    var bms_kingt = require("js/kingdom/ajaxdata");
    var apiname = require("js/kingdom/api_name");
    ...
    showContent.getWorkList = params => {
        ...
        $.kingdom.getList({
            apiName: "kingdom.retl.get_jobs_list",
            apiVision: "v4.0",
            params: _params,
    ...
    showContent.copyWorkList = params => {
        ...
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_job_info_copy", "v4.0", params, data => {
    ...
    showContent.moveWorkInfo = params => {
        ...
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_job_info_change_folder", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                toastr.success(data.bcjson.msg);
    ...
    showContent.delyWorkList = params => {
        ...
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_job_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                toastr.success(data.bcjson.msg);
                showContent.getWorkList();
            } else {
    ...
    showContent.getTaskList = params => {
        ...
        _params = Object.assign(_params, params);
        $.kingdom.getList({
            apiName: "kingdom.retl.get_job_child_tasks_info",
            apiVision: "v4.0",
            params: _params,
