...
define((require, exports, module) => {
    ...
    showContent.getTaskList = params => {
        ...
        $.kingdom.getList({
            apiName: "kingdom.retl.get_task_info",
            apiVision: "v4.0",
            params: _params,
    ...
    showContent.getTaskInfo = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_task_detail_info", "v4.0", params, data => {
    ...
    showContent.moveTaskInfo = params => {
        ...
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_task_folder_trans", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.delTaskInfo = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_task_info_del", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                App.unblockUI();
                toastr.success(data.bcjson.msg);
                showContent.getTaskList();
    ...
    showContent.copyTaskInfo = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_set_task_info_copy", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                App.unblockUI();
                toastr.success(data.bcjson.msg);
                showContent.getTaskList();
    ...
    showContent.checkRelateJob = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_relate_job_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.setTaskInfo = (params, oparatetype, cb) => {
        ...
        let api = oparatetype === "add" ? "kingdom.retl.set_task_info" : "kingdom.retl.set_task_info_modify";
    ...
    showContent.setEditTaskInfo = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.set_task_info_modify", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.getDataSourceList = cb => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_data_source_config", "v4.0", {}, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.getTableList = (params, selector, isTags, cb) => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_metadata_table_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items;
                let arr = [{
                    id: "",
    ...
    showContent.getRuleList = (params, cb) => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_data_rule_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items,
                    arr = [];
                if (items && items.length > 0) {
    ...
    showContent.getSQL = (params, cb) => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_qry_statement", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.getPreviewSQL = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_qry_statement_result", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items;
                if (!items || items.length === 0) {
                    toastr.info("没有查询到数据");
    ...
    showContent.getBuildTableSQL = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_create_statement", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.getDataField = (params, type) => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_column_mapping_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items;
                if (items.length === 0) {
    ...
    showContent.getStoredProcedurePreview = (params, cb) => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_proc_statement", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
    ...
    showContent.testStore = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_proc_test_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                toastr.success(data.bcjson.msg);
            } else {
                toastr.error(data.bcjson.msg);
    ...
    showContent.getDataField_2 = params => {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_metadata_column_info", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items;
                if (items.length === 0) {
                    toastr.info("没有查询到映射字段");
    ...
    */
    ...
    initCodeMirror.prototype.getTable = function(params, cb) {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.get_db_metadata_tables", "v4.0", params, data => {
            if (data.bcjson.flag == "1") {
                let items = data.bcjson.items,
                    obj = {};
                if (items.length === 0) {
