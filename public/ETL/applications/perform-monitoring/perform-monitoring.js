...
define(function(require, exports, module) {
    var showContent = require("theme/perform-monitoring/perform-monitoringShow");
    ...
    $(function() {
        ...
        $("body").on("click", "#perform-monitoring .img-absolute-block .img-absolute", function() {
            ...
            if (index === 0) {
                var hasMoved = $("#right-content-middle-round").scrollLeft() - 868;
        ...
        $("body").on("click", `[href=#pm-tab_1_3]`, function(e) {
            ...
            $.each(checkDom, function(index, value) {
                if (
                    $(value).closest("tr").data("params").taskVars
                ) {
                    checkArray.push(
                        $(value).closest("tr").data("params").taskVars
                    );
