var AppInbox = function () {
    ...
    var loadInbox = function loadInbox(el, name) {
    ...
    var loadMessage = function loadMessage(el, name, resetMenu) {
    ...
    var initWysihtml5 = function initWysihtml5() {
    ...
    var loadCompose = function loadCompose(el) {
    ...
    var loadReply = function loadReply(el) {
    ...
    var handleCCInput = function handleCCInput() {
    ...
    var handleBCCInput = function handleBCCInput() {
    ...
    var toggleButton = function toggleButton(el) {
