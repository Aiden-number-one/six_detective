Handlebars.registerHelper('fileserver', function () {
    // 返回文件服务器
    //return $.kingdom.kconfig().fileserver;
    return $.kingdom.kconfig().fileserver;
});
Handlebars.registerHelper('plus', function (num1, num2, fix) {
    // 加法
...
Handlebars.registerHelper('minus', function (num1, num2, fix) {
    // 减法
    var result = parseFloat(num1) - parseFloat(num2);
    fix = parseFloat(fix);
    if (fix >= 0) {
...
Handlebars.registerHelper('bigminus', function (num1, num2, fix) {
    // 大数字的减法精确计算的bug
    var num11, num22, m;
    try {
...
Handlebars.registerHelper('times', function (num1, num2, fix) {
    // 乘法
    var result = parseFloat(num1) * parseFloat(num2);
    fix = parseFloat(fix);
    if (fix >= 0) {
...
Handlebars.registerHelper('division', function (num1, num2, fix) {
    // 除法
    var result = parseFloat(num1) / parseFloat(num2);
    fix = parseFloat(fix);
    if (fix >= 0) {
...
Handlebars.registerHelper("nulltips", function (item, result) {
    //如果为空，给默认值
...
//
Handlebars.registerHelper("getColors", function (v1) {
    //判断是否相等
    switch (v1) {
        case "1":
...
//通用的字典转义方法
Handlebars.registerHelper("case1Helper", function (value, val1, txt1) {
    if (v === val1) {
        return txt1;
    } else {
        return v;
...
Handlebars.registerHelper("case2Helper", function (value, val1, txt1, val2, txt2) {
    if (value === val1) {
        return txt1;
    } else if (value === val2) {
        return txt2;
...
Handlebars.registerHelper("case3Helper", function (value, val1, txt1, val2, txt2, val3, txt3) {
    if (value === val1) {
        return txt1;
    } else if (value === val2) {
        return txt2;
...
Handlebars.registerHelper("case4Helper", function (value, val1, txt1, val2, txt2, val3, txt3, val4, txt4) {
    if (value === val1) {
        return txt1;
    } else if (value === val2) {
        return txt2;
...
Handlebars.registerHelper("case5Helper", function (value, val1, txt1, val2, txt2, val3, txt3, val4, txt4, val5, txt5) {
    if (value === val1) {
        return txt1;
    } else if (value === val2) {
        return txt2;
...
Handlebars.registerHelper("case6Helper", function (value, val1, txt1, val2, txt2, val3, txt3, val4, txt4, val5, txt5, val6, txt6) {
    if (value === val1) {
        return txt1;
    } else if (value === val2) {
        return txt2;
