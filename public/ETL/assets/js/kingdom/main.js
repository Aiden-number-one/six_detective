define(function(require, exports, module) {
    ...
    var reset = function(link) {
        kweb.kingdom.doKoauthAdminAPI("kingdom.retl.set_sys_config_clear", "v4.0", {}, function(data) {
    ...
    var createMenu = function(cbfunc) {
        ...
        kweb.kingdom.doKoauthAdminAPI("kingdom.retl.get_dis_employee_menu", "v4.0", api_params, function(data) {
            // var html = "";
            // if (data.bcjson.flag != 1) {
    ...
    var setDistributorLoginPwd1 = function(params) {
        $.kingdom.doKoauthAdminAPI("kingdom.retl.update_dis_employee_pwd", "v4.0", params, function(data) {
            App.unblockUI();
...
/**
    ...
    $(function() {
        ...
        //  //修改平台信息
        // //  $.kingdom.doKoauthAdminAPI("kingdom.retl.get_sys_platform_info", "v4.0", {}, data => {
        ...
        //     $.kingdom.doKoauthAdminAPI("kingdom.retl.get_sys_current_date", "v4.0", {}, function(data) {
        ...
        //             message: "加载调度计划中..."
        //         });
        //         $.kingdom.doKoauthAdminAPI("kingdom.retl.get_schedule_calendar_info", "v4.0", paramsMap, function(data) {
        //             if (data.bcjson.flag === "1") {
        //                 var optionData = [];
        ...
        //         $.kingdom.doKoauthAdminAPI("kingdom.retl.get_schedule_info", "v4.0", paramsMap, function(data) {
        //             if (data.bcjson.flag === "1") {
        //                 var items = data.bcjson.items || [];
        //                 if (items.length > 0) {
        //                     var scheduleList = "";
        ...
        // // // 获取首页邮件统计信息
        // (function() {
        //     $.kingdom.doKoauthAdminAPI("kingdom.retl.get_email_send_info", "v4.0", {}, function(data) {
        //         if (data.bcjson.flag == "1") {
        ...
        // //  铃铛图标信息列表
        // // (function() {
        // //     $.kingdom.doKoauthAdminAPI("kingdom.retl.get_finish_schedule_about_today_info", "v4.0", {}, function(data) {
        ...
        // (function() {
        //     // $.kingdom.doKoauthAdminAPI("kingdom.retl.get_user_info", "v4.0", {}, function(data) {
        //     //     var items = data.bcjson.items || data.bcjson;
        //     //     if (data.bcjson.flag == "1" && items) {
        ...
        //     //     }
        //     // });
        //     // $.kingdom.doKoauthAdminAPI("kingdom.retl.get_version_info", "v4.0", {}, function(data) {
        //     //     if (data.bcjson.flag === "1" && data.bcjson.items) {
        //     //         var items = data.bcjson.items[0];
        //     //         $("#J_currentVersion").html(items.version);
        //     //     }
        //     // });
        //     // $.kingdom.doKoauthAdminAPI("kingdom.retl.get_schedule_index_count_info", "v4.0", {}, function(data) {
        //     //     if (data.bcjson.flag === "1" && data.bcjson.items) {
        //     //         var items = data.bcjson.items[0];
        ...
        //     $.kingdom.getList({
        //         apiName: "kingdom.retl.get_task_detail_info",
        //         apiVision: "v4.0",
        //         params: _params,
