 ...
 */
	...
	$.jstree.core.prototype = {
		...
		create_node : function (par, node, pos, callback, is_loaded) {
			...
			// this.get_node(node).type = types;
			this.get_node(node).icon = par.types;
		 ...
		 */
		edit : function (obj, default_text, maxlength, callback) { 
			...
			*/
			...
			h2 = $("<"+"input />", {
						...
						"css" : {
							...
							"min-width" : "150px" // will be set a bit further down
						},
