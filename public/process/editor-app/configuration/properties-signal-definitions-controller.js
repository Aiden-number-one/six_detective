...
angular.module('activitiModeler').controller('ActivitiSignalDefinitionsPopupCtrl', ['$scope', '$q', '$translate', '$timeout', function($scope, $q, $translate, $timeout) {
    ...
    $q.all([idPromise, namePromise, scopePromise]).then(function(results) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [{
                ...
                field: 'scope',
                displayName: $scope.labels.scopeLabel
            }]
        };
    });
