...
var KisBpmEventListenersPopupCtrl = ['$scope', '$q', '$translate', function($scope, $q, $translate) {
    ...
    if ($scope.property.value !== undefined && $scope.property.value !== null && $scope.property.value.eventListeners !== undefined && $scope.property.value.eventListeners !== null) {
            ...
            afterSelectionChange: function(rowItem, event) {
                ...
                if ($scope.selectedListeners.length > 0) {
                    ...
                    if (!$scope.selectedListeners[0].events || $scope.selectedListeners[0].events.length == 0) {
                        $scope.selectedListeners[0].events = [{
                            event: ''
                        }];
                    }
                }
    ...
    $scope.addEventValue = function(index) {
        $scope.selectedListeners[0].events.splice(index + 1, 0, {
            event: ''
        });
    };
