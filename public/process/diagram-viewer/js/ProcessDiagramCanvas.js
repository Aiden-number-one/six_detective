...
var HIGHLIGHT_COLOR_ERROR = Color.Firebrick1;
var HIGHLIGHT_COLOR_SUCCESS = Color.GREEN;
...
// var DefaultProcessDiagramCanvas = {
	...
	*/
	init: function(width, height, processDefinitionId){
		...
		h.style.width = this.canvasWidth+12;
		h.style.height = this.canvasHeight+12;
...
// TODO: generate polylineId or do something!!
	...
	*/
	...
	highLightActivity: function(activityId){
		...
		shape.attr("stroke-width", THICK_TASK_BORDER_STROKE);
		shape.attr("stroke", HIGHLIGHT_COLOR_SUCCESS);
	},
	...
	highLightFlow: function(flowId){
		...
		var HIGHLIGHT_COLOR;
		if(contextObject.isRoll=='0'){
			HIGHLIGHT_COLOR=HIGHLIGHT_COLOR_SUCCESS
		}else{
