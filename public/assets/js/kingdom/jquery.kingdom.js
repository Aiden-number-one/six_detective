    ...
    $.extend({
        kingdom: {
            ...
            doKoauthAdminAPI: function(api_name, api_version, api_params, cbfunc, method) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function(request) {
                            ...
                            request.setRequestHeader('X-Bc-T', `BCT${window.location.hash.split('?')[1].split('=')[1]}`);
            ...
            logout: function(cbfunc) {
                    ...
                    //     }
                    // }, "json");
                    api_name = "kingdom.retl.set_sys_logout";
                    api_version = "v4.0";
                    api_params = {
            ...
            uploadWithApi: function(form_id, api, cbfunc) {
                ...
                // formData.append("s","s")
                var options = {
                    url: "/retl/rest/admin/v4.0/kingdom.retl." + api + ".json",
                    type: "post",
                    dataType: 'json',
                    data: formData,
                    processData:false,
                    ...
                    beforeSend: function(request) {
                        ...
                        request.setRequestHeader("X-Kweb-Api-Name", $.trim("kingdom.retl.file_sys_config_import.json"));
                    ...
                    success: function(data) {
                        ...
                        if (cbfunc) {
                            ...
                            if (data.bcjson.flag == "0000") {
                                ...
                                $("#catch-error-basic-msg").html(data.bcjson.items[0].message);
                                //请求入参及请求参数
                                var paramApi = "请求API: kingdom.retl.file_sys_config_import.json,<br />";
                                //异常堆栈信息
                                if (data.bcjson.msg) {
                                    $("#catch-error-detail-msg").html(paramApi + data.bcjson.msg.replace(/\n/g,'<br>').replace(/\t/g,'&nbsp;&nbsp;'));
                                } else {
                    ...
                    error: function(e) {
                        ...
                        if (cbfunc) {
                            ...
                            if (data.bcjson.flag == "0000") {
                                ...
                                $("#catch-error-basic-msg").html(data.bcjson.items[0].message);
                                //请求入参及请求参数
                                var paramApi = "请求API: kingdom.retl.file_sys_config_import.json,<br />入参：<br/>";
                                //异常堆栈信息
                                if (data.bcjson.msg) {
                                    $("#catch-error-detail-msg").html(paramApi + data.bcjson.msg.replace(/\n/g,'<br>').replace(/\t/g,'&nbsp;&nbsp;'));
                                } else {
