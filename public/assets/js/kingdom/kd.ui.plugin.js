$.extend({
    ...
    kd: {
        kdTimeout: null,
        kdInterval: null,
        kdLoadImage: function kdLoadImage($obj, src, defaultImg, onLoaded) {
            var self = this;
            this.src = src;
            this.width = 0;
            this.height = 0;
        ...
        kdValidateNull: function kdValidateNull(id, msg) {
            if (id) {
                var $obj = $("#" + id);
        ...
        kdEllipsis: function kdEllipsis($obj) {
            $obj.each(function (i) {
                ...
                var replaceTxt = function replaceTxt(t) {
        ...
        kdPager: {
            ...
            outpage: function outpage() {// 跳转框失去输入焦点时
                /*setTimeout(function() {
            ...
            gopage: function gopage(vobj, vtotalpage, vtagurl) {
            ...
            generPageHtml: function generPageHtml() {
                ...
                if (this.isChangeSize) {
                    $("#" + this.pager).html("<div class='col-md-5 col-sm-12' style='padding-top:8px;'><label style='padding-left:0px'>" + $.i18n.map['records-per-page'] + "&nbsp;&nbsp;<select name='pager_size' style='margin-right: 5px;height: 26px;margin-top: 5px;width: 49px;'><option value='10'>10</option><option value='20'>20</option><option value='50'>50</option><option value='100'>100</option><option value='200'>200</option></select></label>" + total_info.join("") + "</div><div class='col-md-7 col-sm-12 text-right'><ul class='pagination pagination-sm'>" + str_prv.join("") + str.join("") + str_next.join("") + "</ul>" + gopage_info.join(""));
                } else {
                    $("#" + this.pager).html("<div class='col-md-4 col-sm-12' style='padding-top:8px;'>" + total_info.join("") + gopage_info.join("") + "</div><div class='col-md-7 col-sm-12 text-right'><ul class='pagination'>" + str_prv.join("") + str.join("") + str_next.join("") + "</ul></div>");
                }
            }
        },

        showLoading: function showLoading($obj, txt) {
        ...
        tableShowLoading: function tableShowLoading($obj) {
            $($obj).each(function () {
