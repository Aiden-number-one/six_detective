define(function(require, exports, module) {
    ...
    var Login = function() {
        ...
        function getAuthorizationTime (startTime){
                var options = {
                    url:
                      ...
                      "/retl/rest/admin/v4.0/kingdom.retl.get_auth_info.json",
                    type: "POST",
                    dataType: "json",
        ...
        (function getAuthorizationDay (){  
            $.kingdom.doKoauthAdminAPI(" kingdom.retl.get_sys_param_info","v4.0", {"groupNo":"group.authinfo.warn","paramKey":"group.authinfo.warn.deadline"},
                function(data) {
        ...
        var submitForm = function() {
            ...
            kweb.kingdom.doKoauthAdminAPI("kingdom.retl.set_dis_employee_login", "v4.0", api_params, function(data) {
        ...
        var loadvalidateimg = function() {
            ...
            kweb.kdata.getBackApiJsonAsync("kingdom.retl.get_base64_image_validcode_v4", "v4.0", {}, function(data) {
                // $.kingdom.doKoauthAdminAPI("kingdom.retl.get_base64_image_validcode_v4", "v4.0", {}, function(data) {
                $(".img-validate").attr("src", data.bcjson.items[0].validcode);
                uniqueID = data.bcjson.items[0].uniqueID;
            });
        ...
        $("body").on("click", "#uml-forgetUserBt", function() {
            ...
            $.kingdom.doKoauthAdminAPI("kingdom.retl.update_dis_employee_pwd", "v4.0", paramsMap, function(data) {
                var items = data.bcjson.items || data.bcjson;
                if (data.bcjson.flag == "0") {
                    $("#VerificationCodeId").trigger("bc.clear");
                    toastr.options = {
        ...
        var validateimg = function(value, element) {
            var result = false;
            kweb.kingdom.doKoauthAdminAPISync("kingdom.retl.set_check_base64_image_validcode", "v4.0", {
                "uniqueID": uniqueID,
