    ...
    return { init: function init() {
            ...
            if (jQuery().fullCalendar) {
                ...
                $("#external-events div.external-event").each(function () {
                    ...
                    o(e);
                }), $("#event_box").html(""), o("My Event 1"), o("My Event 2"), o("My Event 3"), o("My Event 4"), o("My Event 5"), o("My Event 6"), $("#calendar").fullCalendar("destroy"), $("#calendar").fullCalendar({ header: r, defaultView: "month", slotMinutes: 15, editable: !0, droppable: !0, drop: function drop(e, t) {
