...
var Datatable = function Datatable() {
    ...
    var countSelectedRecords = function countSelectedRecords() {
    ...
    return {
        ...
        setAjaxParam: function setAjaxParam(name, value) {
            ajaxParams[name] = value;
        },

        addAjaxParam: function addAjaxParam(name, value) {
            if (!ajaxParams[name]) {
                ajaxParams[name] = [];
            }
        ...
        clearAjaxParams: function clearAjaxParams(name, value) {
            ajaxParams = {};
        },
        ...
        getTableWrapper: function getTableWrapper() {
            return tableWrapper;
        },
