...
(function (a) {
  function b(a, b, c) {
    ...
    }), V(b)) : "object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) ? W(b) : "number" == typeof d ? b._d = new Date(d) : vb.createFromInputFallback(b);
    ...
    }, h = { y: f(i[2]), M: f(i[3]), d: f(i[4]), h: f(i[5]), m: f(i[6]), s: f(i[7]), w: f(i[8]) }) : null == h ? h = {} : "object" == (typeof h === "undefined" ? "undefined" : _typeof(h)) && ("from" in h || "to" in h) && (g = t(vb(h.from), vb(h.to)), h = {}, h.ms = g.milliseconds, h.M = g.months), e = new n(h), vb.isDuration(a) && c(a, "_locale") && (e._locale = a._locale), e;
