var QuickSidebar = function () {
  var i = function i() {
    ...
    var i = $(".page-quick-sidebar-wrapper"),
      ...
      var a,
          e = i.find(".page-quick-sidebar-alerts-list");a = i.height() - i.find(".nav-justified > .nav-tabs").outerHeight(), App.destroySlimScroll(e), e.attr("data-height", a), App.initSlimScroll(e);
    ...
    var i = $(".page-quick-sidebar-wrapper"),
      ...
      var a,
          e = i.find(".page-quick-sidebar-settings-list");a = i.height() - i.find(".nav-justified > .nav-tabs").outerHeight(), App.destroySlimScroll(e), e.attr("data-height", a), App.initSlimScroll(e);
    });a(), App.addResizeHandler(a);
